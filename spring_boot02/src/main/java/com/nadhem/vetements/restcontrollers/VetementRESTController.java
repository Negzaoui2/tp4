package com.nadhem.vetements.restcontrollers;
...
import com.nadhem.vetements.service.VetementService;
...
public class VetementRESTController {
   ...
   { 
	   return 
			   vetementService.getVetement(id);
   }
   ...
   @RequestMapping(value="/prodscat/{idM}",method = RequestMethod.GET)
   public List<Vetement> getVetementsByMId(@PathVariable("idM") Long idCat)
   {
       return vetementService.findByMarqueIdM(idCat);
   }
